...
<body>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="classroom_name" value="<?php echo $_GET['name']; ?>">
                    </div>
                  </div>
                  <div class="card-footer text-right">
                    <button class="btn btn-primary mr-1" onclick="editClassroom()">Submit</button>
                  </div>
  ...
  <script type="module">
    ...
    const classroom = doc(db, 'classrooms/<?php echo $_GET['id']; ?>');
    ...
    window.editClassroom = async function editClassroom() {
      await updateDoc(classroom, {
        name: document.getElementById("classroom_name").value
      });

      alert('Classroom been edited!');
      window.location.href = "/adminpanel/classroom.html";
    }

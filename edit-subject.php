...
<body>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="subject_title" value="<?php echo $_GET['title']; ?>">
                    </div>
                    <div class="form-group">
                      <label>Subject year</label>
                      <input type="text" class="form-control" id="subject_desc" value="<?php echo $_GET['desc']; ?>">
                    </div>
                  </div>
                  <div class="card-footer text-right">
                    <button class="btn btn-primary mr-1" onclick="editSubject()">Submit</button>
                  </div>
  ...
  <script type="module">
    ...
    const subject = doc(db, 'subjects/<?php echo $_GET['id']; ?>');
    ...
    window.editSubject = async function editSubject() {
      await updateDoc(subject, {
        title: document.getElementById("subject_title").value,
        desc: document.getElementById("subject_desc").value,
      });

      alert('Subject been edited!');
      window.location.href = "/adminpanel/subject.html";
    }

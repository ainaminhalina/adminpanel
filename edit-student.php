...
<body>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="student_displayname" value="<?php echo $_GET['displayName']; ?>">
                    </div>
                    <div class="form-group">
                      <label>Student phone number</label>
                      <input type="text" class="form-control" id="student_phonenumber" value="<?php echo $_GET['phoneNumber']; ?>">
                    </div>
                  </div>
                  <div class="card-footer text-right">
                    <button class="btn btn-primary mr-1" onclick="editStudent()">Submit</button>
                  </div>
  ...
  <script type="module">
    ...
    const student = doc(db, 'users/<?php echo $_GET['id']; ?>');
    ...
    window.editStudent = async function editStudent() {
      await updateDoc(student, {
        displayName: document.getElementById("student_displayname").value,
        phoneNumber: document.getElementById("student_phonenumber").value,
      });

      alert('Student been edited!');
      window.location.href = "/adminpanel/student.html";
    }

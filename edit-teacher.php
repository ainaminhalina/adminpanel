...
<body>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="teacher_displayname" value="<?php echo $_GET['displayName']; ?>">
                    </div>
                    <div class="form-group">
                      <label>Teacher phone number</label>
                      <input type="text" class="form-control" id="teacher_phonenumber" value="<?php echo $_GET['phoneNumber']; ?>">
                    </div>
                  </div>
                  <div class="card-footer text-right">
                    <button class="btn btn-primary mr-1" onclick="editTeacher()">Submit</button>
                  </div>
  ...
  <script type="module">
    ...
    import { getFirestore, collection, getDocs, getDoc, query, where, orderBy, addDoc, doc, updateDoc, setDoc } from "https://www.gstatic.com/firebasejs/9.0.0/firebase-firestore.js";
    ...
    const teacher = doc(db, 'users/<?php echo $_GET['id']; ?>');
    ...
    window.editTeacher = async function editTeacher() {
      await updateDoc(teacher, {
        displayName: document.getElementById("teacher_displayname").value,
        phoneNumber: document.getElementById("teacher_phonenumber").value,
      });

      alert('Teacher been edited!');
